...
puzzle = Mesostic(
    ...
    MesosticWord( "SHRUBERRY", 1, "The Knights of Ni!'s first demand was to get a" ), \
    MesosticWord( "COCONUT", 5, "A horse can be replaced by a" ), \
    MesosticWord( "MINSTRELS", 5, "They were forced to eat Robin's" ) ] )
