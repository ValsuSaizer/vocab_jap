...
#Enlever le dièse devant la ligne de vocabulaire que tu souhaites ajouter dans un csv.
#A executer depuis un invite de commande, le programme affiche ce qui a été écrit à la fin.
